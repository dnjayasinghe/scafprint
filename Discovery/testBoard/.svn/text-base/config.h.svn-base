...
/******************************************************************************
 * Parametres a modifier avant de compiler avec make
 ******************************************************************************/
//Choisir le type d'implementation
//#define ECP_MUL  //<-- Multiplication scalaire classique de PolarSSL
//#define DBL_AND_ADD_AFF //<--Double-and-add classique VI affine coordinates
//#define DBL_AND_ADD_JAC// <--Double-and-add classique VI jacobian coordinates
//#define DBL_AND_ALWAYS_ADD_AFF// <--Double-and-always-add  VI affine coordinates
//#define DBL_AND_ALWAYS_ADD_JAC // <--Double-and-always-add  VI jacobian coordinates
//#define ADD_ALWAYS // <-- Add_always with unified addition in jacobian coordinates
//#define MULTIPLICATION
#define SQUARE 
//#define MULT_32x32

//#define ATTAQUE_TIMING_MUL  //<-- Attaque sur le temps de la multiplication
//#define __TRIGGERMULT__
//choisir si on utilise l'UART ou non 
#define __UART__  //<-- Utilisation de l'UART 

//choisir le type de courbe
#define NIST	// <-- Definir la courbe utilisee
//#define BRAIN     


//#define __MY_PRINTF__ //<-- Parametre l'utilisation ou non des printf dans le code
//#define IO_ECP 
//#define __MINICOM__
/******************************************************************************
 * Fin des parametres a modifier avant de compiler avec make
 ******************************************************************************/
...
//Librairie pour utiliser l'UART et les Triggers
#include "stm32f4xx_conf.h"
#include "stm32f4xx.h" 
//Librairie de PolarSSL utilisee
#include "polarssl/bignum.h"
#include "polarssl/ecp.h"
//Librairie de C usuelle
#include <stdio.h>
#include <stdlib.h>
#include <stdint.h>
#include <math.h>

#if defined(DBL_AND_ADD_AFF)
#include "dblandadd.h"
#endif 
#if defined(DBL_AND_ADD_JAC)
#include "dblandadd.h"
#endif 

#if (defined(MULTIPLICATION)|| defined(SQUARE))
#include "multiplication.h"
#endif 

//#if defined(MULT_32x32)
//#include "mult_32x32.h"
//#endif 


#if defined(DBL_AND_ALWAYS_ADD_AFF)
#include "dblandalwaysadd.h"
#endif 
#if defined(DBL_AND_ALWAYS_ADD_JAC)
#include "dblandalwaysadd.h"
#endif

#if defined (ADD_ALWAYS) 
#include "ecp_unified_addition.h"
#include "add_always.h"
#endif
...
#if defined(ATTAQUE_TIMING_MUL)
#define __TRIGGERMULT__
#include "attaqueTimingMul.h"
#endif

#if defined(__MINICOM__)
#define IO_ECP
#endif
...
//#define POLARSSL_ECP_WINDOW_SIZE            2 /**< Maximum window size used */
